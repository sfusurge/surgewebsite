                        ...
                        <Col>
                            <div className="eventsBgRectangles">
                                ...
                                <div className="eventTexts">
                                    ...
                                    <p className="eventTextStyle">Want to learn more about the process of entrepreneurship and the intersections between business and technology? We are thrilled to announce TECH Talk with guest speaker Jeremy Becker! <a href="" className="learnMoreStyle">Learn More</a></p>
                                </div>
                            </div>
                        </Col>
{/*  EVENT2  */}
                        <Col>
                            <div className="eventsBgRectangles">
                                ...
                                <div className="eventTexts">
                                    ...
                                    <p className="eventTextStyle">On November 22, Kasra Jamshidi will be teaching the basic skills and foundation needed to operate and run Linux. A majority (if not all) of tech-related jobs and classes rely heavily on this system, especially scripting. <a href="" className="learnMoreStyle">Learn More</a></p>
                                </div>
                            </div>
                        </Col>
...
{/*  COMING SOON */}
                        <Col>
                            <div className="moreComing">
                                <p className="moreComingStyle">More Events Coming Soon!</p>
                            </div>
                        </Col>
